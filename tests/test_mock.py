...
This test module provides mocked unit tests for all 28 endpoint modules,
...
class TestEndpointSignatures:
    """Test that all 28 endpoint modules have correct method signatures."""
